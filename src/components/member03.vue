<template>
  <div class="user">
      <div class="uwb">
          <div class="uvip">
              <p class="vcnam"><img :src="require('./../components/img/cname.png')"></p>
              <p class="vfot">给球队一分支持，创足球十分精彩</p>
          </div>
          <div class="boxw">
          <div class="box">
      ...
      <ul class="uslis">
            <li>
             <router-link :to="{name:'message'}" class="userouter">
                <i class="iconfont icon-message ufico f26"></i>
                <span class="ucd">消息中心</span>
             </router-link>
            </li>
            <li>
                <router-link :to="{name:'feedback'}" class="userouter">
                    <i class="iconfont icon-feedback02 ufico"></i>
                    <span class="ucd">意见反馈</span>
                </router-link>
            </li>
            <li>
                <router-link :to="{name:'profile'}" class="userouter">
                    <i class="iconfont icon-profile ufico"></i>
                    <span class="ucd">个人资料</span>
                </router-link>
            </li>
            <li>
            ...
            <li>
                <router-link :to="{name:'fans'}" class="userouter">
                    <i class="iconfont icon-message01 ufico"></i>
            ...
            <li>
                <router-link :to="{name:'vip'}" class="userouter">
                    <i class="iconfont icon-member01 ufico"></i>
                    <span class="ucd">会员俱乐部</span>
                </router-link>
            </li>
            <li>
                <router-link :to="{name:'shoper'}" class="userouter">
                    <i class="iconfont icon-shopping01 ufico"></i>
                    <span class="ucd">积分商城</span>
                </router-link>
            </li>
      </ul>
  </div>
